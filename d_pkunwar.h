...
short *pAY8910Buffer[6]= {NULL, NULL, NULL, NULL, NULL, NULL}, *pFMBuffer = NULL;
UINT8 *DrvMainROM = NULL;
UINT8 *DrvSubROM = NULL;
UINT8 *DrvGfxROM0 = NULL;
UINT8 *DrvGfxTmp = NULL;
//UINT8 *MemEnd = NULL;
UINT8 *DrvMainRAM = NULL;
...
UINT32 *offs_lut = NULL;
UINT16 *cram_lut = NULL;
UINT8 *CZ80Context = NULL;

UINT32 DrvCoinHold = 0;
UINT32 DrvCoinHoldframecnt = 0;
UINT32 flipscreen = 0;
INT32 xscroll = 0;
INT32 yscroll = 0;
UINT32 watchdog = 0;
UINT8 ninjakun_ioctrl = 0;
