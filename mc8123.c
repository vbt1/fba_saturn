...
int decrypt_type0(int val,int param,int swap)
{
...
int decrypt_type1a(int val,int param,int swap)
{
...
int decrypt_type1b(int val,int param,int swap)
{
...
int decrypt_type2a(int val,int param,int swap)
{
...
int decrypt_type2b(int val,int param,int swap)
{
...
int decrypt_type3a(int val,int param,int swap)
{
...
int decrypt_type3b(int val,int param,int swap)
{
...
int decrypt(int val, int key, int opcode)
{
	int type = 0;
	int swap = 0;
	int param = 0;
...
UINT8 mc8123_decrypt(int addr,UINT8 val,const UINT8 *key,int opcode)
{
	int tbl_num;
