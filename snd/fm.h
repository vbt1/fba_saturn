...
typedef unsigned short	Usigned short;  /* unsigned 16bit */
typedef unsigned int	UINT32;  /* unsigned 32bit */
typedef signed char		INT8;    /* signed  8bit   */
typedef signed short	signed short;   /* signed 16bit   */
...
** update one of chip
*/
void YM2203UpdateOne(int num, signed short *buffer, int length);
...
void YM2608UpdateOne(int num, signed short **buffer, int length);
...
void YM2610UpdateOne(int num, signed short **buffer, int length);
#if BUILD_YM2610B
void YM2610BUpdateOne(int num, signed short **buffer, int length);
#endif
...
void YM2612UpdateOne(int num, signed short **buffer, int length);
...
void OPMUpdateOne(int num, signed short **buffer, int length );
