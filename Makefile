...
SRCOVLMITCH         = d_mitchell.c czet.c cz80/cz80.c kabuki.c snd/msm6295.c burn_sound_c.c eeprom.c load.c saturn/ovl.c saturn/saturn_snd.c saturn/pcmsys.c
...
SRCOVLSYS1         = d_sys1.c czet.c cz80sys1/cz80.c snd/sn76496.c load.c saturn/ovl.c saturn/saturn_ext.c
...
OVL1943                 = root/d_1943.coff
OVL19431               = root/d_1943.bin
MPOVL1943FILE    = $(OVL1943:.coff=.maps)
