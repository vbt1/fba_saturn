...
{
/* vbt ‡ remettre	void (*fp)(unsigned int);
	fp = (void *)LOWADDR;
	(*fp)(id);
...
//	heapWalk();
	...
	do
	{
		if(!loaded)
		{
// vbt ‡ remette			GFS_Load(GFS_NameToId("IMG.BIN"),  0,(void *)LOWADDR, GFS_BUFSIZ_INF);
			load_img(0);	
			loaded=1;
...
// vbt ‡ remettre    		GFS_Load(GFS_NameToId(strupr(drv_file)), 0, (void *)OVLADDR, GFS_BUFSIZ_INF);
